...
export function isMenuBarReactProps(obj: unknown): obj is menubarReactProps {
    ...
    return (
        ...
        ((typedObj["children"][1] !== null && typeof typedObj["children"][1] === "object") ||
            typeof typedObj["children"][1] === "function") &&
        ((typedObj["children"][1]["props"] !== null && typeof typedObj["children"][1]["props"] === "object") ||
        ...
        ((typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"] !== null &&
            ...
            typeof typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"] ===
                "function") &&
        (typeof typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"][
            "possibly_sensitive"
        ] === "undefined" ||
            typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"][
                "possibly_sensitive"
            ] === null ||
            typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"][
                "possibly_sensitive"
        ...
        typeof typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"]["permalink"] ===
            "string" &&
        ((typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"]["user"] !== null &&
            typeof typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"]["user"] ===
                "object") ||
            typeof typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"]["user"] ===
                "function") &&
        (typeof typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"]["user"][
            ...
            typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"]["user"][
                "possibly_sensitive"
            ] === null ||
            typedObj["children"][1]["props"]["retweetWithCommentLink"]["state"]["quotedStatus"]["user"][
                "possibly_sensitive"
